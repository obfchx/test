...
OkayBtn.Text = ""
OkayBtn.TextColor3 = Color3.new(0,0,0)
...
OkayBtnTitle.BackgroundColor3 = Color3.new(0,0,0)
...
Main:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    Main:AddToggle("Auto Drive",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    Main:AddToggle("Auto Summon Mirage Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Main:AddToggle("Teleport Advanced Fruit Dealer",_G.TPNPC,function(value)
             _G.Miragenpc = value
...
Main:AddButton("Teleport Advanced Fruit Dealer", function()
                TweenNpc()
                end)
...
Main:AddToggle("Tween Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
