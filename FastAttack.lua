...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Sub Farming", Icon = "" }),
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Seaev:AddToggle("ToggleSailBoat", {Title = "Auto Buy Boat and sit",Description = "Mua thuyền và ngồi", Default = false })
...
local ToggleFastLow = Tabs.Setting:AddToggle("ToggleFastLow", {Title = "Enabled Fast Attack (for low mobile & pc)",Description = "�nh nhanh cho m�y yu", Default = true })
ToggleFastLow:OnChanged(function(Value)
    getgenv().FastNelow = Value
end)
Options.ToggleFastLow:SetValue(true)
